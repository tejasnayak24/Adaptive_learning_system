      ...
      <div className="w-full max-w-md space-y-8 z-10">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-center font-display text-4xl font-extrabold tracking-tight text-white">
            Welcome back to <span className="bg-gradient-to-r from-indigo-400 to-teal-300 bg-clip-text text-transparent">Aegis</span>
          </h2>
